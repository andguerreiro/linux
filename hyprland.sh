...
echo "==> Hyprland first run setup (Arch Linux | JetBrains Mono Nerd Font)"
...
# --------------------------------
# Fontconfig – system defaults
# --------------------------------
echo "==> Setting system font defaults"
...
echo "==> Setup complete"
echo "==> Log out and back in to Hyprland"#!/usr/bin/env bash
set -e
